...
type Token struct {
	...
	UserCode            string `json:"userCode,omitempty" orm:"index" url:"-"`
	AccessToken         string `json:"accessToken" url:"-"`
	RefreshToken        string `json:"refreshToken" url:"-"`
	AccessTokenHash     string `json:"accessTokenHash" orm:"index" url:"-"`
	RefreshTokenHash    string `json:"refreshTokenHash" orm:"index" url:"-"`
	ExpiresIn           int    `json:"expiresIn" url:"-"`
	Scope               string `json:"scope" url:"-"`
	TokenType           string `json:"tokenType" url:"-"`
	CodeChallenge       string `json:"codeChallenge" url:"-"`
	CodeChallengeMethod string `json:"codeChallengeMethod" url:"-"`
	CodeIsUsed          bool   `json:"codeIsUsed" url:"-"`
	CodeExpireIn        int64  `json:"codeExpireIn" url:"-"`
	Resource            string `json:"resource" url:"-"` // RFC 8707 resource indicator
	...
	RefreshFamily   string `json:"refreshFamily,omitempty" orm:"index" url:"-"`
	RefreshConsumed bool   `json:"refreshConsumed,omitempty" url:"-"`
	RefreshExpireIn int64  `json:"refreshExpireIn,omitempty" url:"-"`
