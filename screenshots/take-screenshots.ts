...
(async () => {
  ...
  const pages = [
    { url: 'https://iam.next.example.internal/login', name: '01-login' },
    { url: 'https://iam.next.example.internal/signup', name: '02-signup' },
    { url: 'https://iam.next.example.internal/nonexistent-page-404', name: '03-404' },
    { url: 'https://iam.next.example.internal/', name: '04-home' },
  ];
