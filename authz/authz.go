...
p, *, *, GET, /v1/iam/.well-known/openid-configuration, *, *
p, *, *, GET, /v1/iam/.well-known/webfinger, *, *
p, *, *, *, /v1/iam/.well-known/jwks, *, *
p, *, *, GET, /v1/iam/.well-known/oauth-authorization-server, *, *
p, *, *, GET, /v1/iam/.well-known/oauth-protected-resource, *, *
p, *, *, GET, /v1/iam/.well-known/:application/openid-configuration, *, *
p, *, *, GET, /v1/iam/.well-known/:application/webfinger, *, *
p, *, *, *, /v1/iam/.well-known/:application/jwks, *, *
p, *, *, GET, /v1/iam/.well-known/:application/oauth-authorization-server, *, *
p, *, *, GET, /v1/iam/.well-known/:application/oauth-protected-resource, *, *
...
func IsAllowed(subOwner string, subName string, method string, urlPath string, objOwner string, objName string, extraInfo map[string]interface{}) bool {
	...
	if user != nil {
		...
		// above by user.IsSuperAdmin()) may read/enumerate it. The former
		...
		// Casbin grants + handler-level IsSuperAdmin guards; this removes only
