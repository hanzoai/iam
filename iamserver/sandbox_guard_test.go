...
func TestHostMatchesSandboxAllowlist(t *testing.T) {
	cases := []struct {
		...
		// Allowed
		{"iam.dev.satschel.com", true},
		{"iam.test.satschel.com", true},
		{"localhost", true},
		{"localhost:8000", true},
		{"127.0.0.1", true},
		{"127.0.0.1:8000", true},
		{"foo.local", true},
		{"dev.satschel.com", true}, // apex of sandbox suffix
		// Disallowed
		{"iam.satschel.com", false},
		{"iam.main.satschel.com", false},
		{"iam.liquidity.io", false},
		{"hanzo.id", false},
		{"", false},
		{"evil.dev.satschel.com.attacker.com", false},
	}
	for _, c := range cases {
...
func TestExtractHost(t *testing.T) {
	cases := []struct {
		...
		{"iam.dev.satschel.com", "iam.dev.satschel.com"},
		{"https://iam.dev.satschel.com", "iam.dev.satschel.com"},
		{"https://iam.main.satschel.com:8443/path", "iam.main.satschel.com:8443"},
		{"", ""},
	}
	for _, c := range cases {
...
func TestEnforceSandboxOriginGuard_PanicsOnProdOrigin(t *testing.T) {
	...
	os.Setenv("ORIGIN", "https://iam.main.satschel.com")
...
func TestEnforceSandboxOriginGuard_AllowsSandboxOrigin(t *testing.T) {
	...
	os.Setenv("SANDBOX_GLOBAL_OTP", "999999")
	os.Setenv("ORIGIN", "https://iam.dev.satschel.com")
	// Must not panic.
	EnforceSandboxOriginGuard()
}
