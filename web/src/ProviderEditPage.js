          ...
          <Col span={22} >
            <Select virtual={false} style={{width: "100%"}} showSearch value={this.state.provider.type} onChange={(value => {
              ...
              if (value === "Local File System") {
                ...
                this.updateProviderField("customAuthUrl", "https://door.iam.com/login/oauth/authorize");
                this.updateProviderField("scopes", "openid profile email");
                this.updateProviderField("customTokenUrl", "https://door.iam.com/api/login/oauth/access_token");
                this.updateProviderField("customUserInfoUrl", "https://door.iam.com/api/userinfo");
          ...
          this.state.provider.category === "Notification" ? (
            ...
            <React.Fragment>
              ...
              <Row style={{marginTop: "20px"}} >
                ...
                <Col span={22} >
                  <Row style={{marginTop: "20px"}} >
                    <Button style={{marginLeft: "10px", marginBottom: "5px"}} onClick={() => this.updateProviderField("content", "You have requested a verification code at Hanzo IAM. Here is your code: %s, please enter in 5 minutes. <reset-link>Or click %link to reset</reset-link>")} >
              ...
              <Row style={{marginTop: "20px"}} >
                ...
                <Col span={22} >
                  <Row style={{marginTop: "20px"}} >
                    <Button style={{marginLeft: "10px", marginBottom: "5px"}} onClick={() => this.updateProviderField("metadata", "You have invited to join Hanzo IAM. Here is your invitation code: %s, please enter in 5 minutes. Or click %link to signup")} >
                      {i18next.t("general:Reset to Default")}
                    </Button>
