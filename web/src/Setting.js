...
export const UserFields = ["owner", "name", "password", "display_name", "id", "type", "email", "phone", "country_code",
  ...
  "weibo", "gitee", "linkedin", "wecom", "lark", "gitlab", "adfs", "baidu", "alipay", "iam", "infoflow", "apple",
  ...
  if (application.homepageUrl !== "") {
    return (
      <a target="_blank" rel="noreferrer" href={application.homepageUrl}>
        <img className="panel-logo" width={80} src={application.logo} alt={application.displayName} />
      </a>
    );
  } else {
    return (
