        ...
        <div className="split-login-container">
          ...
          <div className={`split-login-form ${isDarkMode ? "loginBackgroundDark" : "loginBackground"}`}
            ...
            <Switch>
              ...
              <Route exact path="/oauth/authorize" render={(props) => <LoginPage {...this.props} application={this.state.application} type={"code"} mode={"signin"} onUpdateApplication={onUpdateApplication} {...props} />} />
