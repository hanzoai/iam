...
// and the deployer pins the apex list (e.g. `example.com,example.io`
// for a tenant, `hanzo.ai,hanzo.app` for Hanzo, etc.). An origin passes
// if its hostname equals or is a subdomain of one of these entries.
