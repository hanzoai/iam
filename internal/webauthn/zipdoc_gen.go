...
func init() {
	zip.Describe("github.com/hanzoai/iam/internal/webauthn DELETE /v1/iam/webauthn-credentials/:owner/:name", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/webauthn GET /v1/iam/webauthn-credentials", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/webauthn GET /v1/iam/webauthn-credentials/:owner/:name", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/webauthn POST /v1/iam/webauthn-credentials", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/webauthn PUT /v1/iam/webauthn-credentials/:owner/:name", zip.Doc{
