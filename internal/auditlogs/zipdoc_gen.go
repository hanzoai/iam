...
func init() {
	zip.Describe("github.com/hanzoai/iam/internal/auditlogs DELETE /v1/iam/audit-logs/:owner/:name", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/auditlogs GET /v1/iam/audit-logs", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/auditlogs GET /v1/iam/audit-logs/:owner/:name", zip.Doc{
		Description: "Returns one audit entry in full: the action, the person or key behind it,\nand the request it came in on.",
		Fields: map[string]string{
			"Model[github.com/hanzoai/iam/pkg/schema.AuditLog].id": "Persisted fields",
		},
	})
	zip.Describe("github.com/hanzoai/iam/internal/auditlogs POST /v1/iam/audit-logs", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/auditlogs PUT /v1/iam/audit-logs/:owner/:name", zip.Doc{
