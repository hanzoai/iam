...
func init() {
	zip.Describe("DELETE /v1/iam/invitations/:owner/:name", zip.Doc{
	...
	zip.Describe("GET /v1/iam/invitations/:owner/:name", zip.Doc{
	...
	zip.Describe("PUT /v1/iam/invitations/:owner/:name", zip.Doc{
