...
func init() {
	zip.Describe("github.com/hanzoai/iam/internal/applications DELETE /v1/iam/applications/:owner/:name", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/applications GET /v1/iam/applications", zip.Doc{
