...
func init() {
	zip.Describe("github.com/hanzoai/iam/internal/resolve GET /v1/iam/keys/org", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/resolve GET /v1/iam/keys/principal", zip.Doc{
