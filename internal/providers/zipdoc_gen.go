...
func init() {
	zip.Describe("github.com/hanzoai/iam/internal/providers DELETE /v1/iam/providers/:owner/:name", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/providers GET /v1/iam/providers", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/providers GET /v1/iam/providers/:owner/:name", zip.Doc{
		Description: "Returns one provider: what it connects to and how it is\nconfigured. Its credentials come back masked.",
		Fields: map[string]string{
			"Model[github.com/hanzoai/iam/pkg/schema.Provider].id": "Persisted fields",
		},
	})
	zip.Describe("github.com/hanzoai/iam/internal/providers POST /v1/iam/providers", zip.Doc{
	...
	zip.Describe("github.com/hanzoai/iam/internal/providers PUT /v1/iam/providers/:owner/:name", zip.Doc{
