...
func TestListedConsoleStillCannotReadTheAccountWithTheCookie(t *testing.T) {
	...
	for _, path := range []string{
		readPath, "/v1/iam/oauth/userinfo", "/v1/iam/users",
...
func TestCookieSurfaceIsExactlyTheShippedSDKsCredentialedSites(t *testing.T) {
	...
	for _, p := range []string{
		"/v1/iam/account", "/v1/iam/oauth/userinfo", "/v1/iam/users",
		"/v1/iam/organizations", "/v1/iam/oauth/token", "/v1/iam/organizations",
		"/v1/iam/invitations", "/v1/iam/organizations/get",
	} {
