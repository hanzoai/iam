...
// keys/principal is its secret-key twin and is here for the identical reason.
//
// Both are listed EXACTLY rather than as a prefix, and that is the whole reason this
// map is separate from the one above: "/v1/iam/keys/principal" under a prefix rule
